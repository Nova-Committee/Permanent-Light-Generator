...
public class PL512BlockEntity extends BlockEntity {
    private final Long generation = 512L;
    ...
    public PL512BlockEntity(BlockPos pos, BlockState state) {
        super(PL512_BLOCK_ENTITY, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, PL512BlockEntity be) {
        if (world == null) {
            return;
        }
