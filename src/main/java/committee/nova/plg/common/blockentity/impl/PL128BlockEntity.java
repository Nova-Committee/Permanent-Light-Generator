...
public class PL128BlockEntity extends BlockEntity {
    private final Long generation = 128L;
    ...
    public PL128BlockEntity(BlockPos pos, BlockState state) {
        super(PL128_BLOCK_ENTITY, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, PL128BlockEntity be) {
        assert world != null;
