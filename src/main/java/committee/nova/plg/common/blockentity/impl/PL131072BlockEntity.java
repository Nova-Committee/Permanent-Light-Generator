...
public class PL131072BlockEntity extends BlockEntity {
    private final Long generation = 131072L;
    ...
    public PL131072BlockEntity(BlockPos pos, BlockState state) {
        super(PL131072_BLOCK_ENTITY, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, PL131072BlockEntity be) {
        if (world == null) {
            return;
        }
