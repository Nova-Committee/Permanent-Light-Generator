...
public class PL32768BlockEntity extends BlockEntity {
    private final Long generation = 32768L;
    ...
    public PL32768BlockEntity(BlockPos pos, BlockState state) {
        super(PL32768_BLOCK_ENTITY, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, PL32768BlockEntity be) {
        assert world != null;
