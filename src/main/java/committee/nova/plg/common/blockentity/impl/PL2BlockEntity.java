...
public class PL2BlockEntity extends BlockEntity {
    private final Long generation = 2L;
    ...
    public PL2BlockEntity(BlockPos pos, BlockState state) {
        super(PL2_BLOCK_ENTITY, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, PL2BlockEntity be) {
        assert world != null;
