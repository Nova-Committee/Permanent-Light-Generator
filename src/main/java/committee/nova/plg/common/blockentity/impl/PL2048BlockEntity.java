...
public class PL2048BlockEntity extends BlockEntity {
    private final Long generation = 2048L;
    ...
    public PL2048BlockEntity(BlockPos pos, BlockState state) {
        super(PL2048_BLOCK_ENTITY, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, PL2048BlockEntity be) {
        if (world == null) {
            return;
        }
