...
public class PL8BlockEntity extends BlockEntity {
    private final Long generation = 8L;
    ...
    public PL8BlockEntity(BlockPos pos, BlockState state) {
        super(PL8_BLOCK_ENTITY, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, PL8BlockEntity be) {
        assert world != null;
