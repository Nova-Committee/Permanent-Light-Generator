...
public class PL32BlockEntity extends BlockEntity {
    private final Long generation = 32L;
    ...
    public PL32BlockEntity(BlockPos pos, BlockState state) {
        super(PL32_BLOCK_ENTITY, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, PL32BlockEntity be) {
        if (world == null) {
            return;
        }
